        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                ...
                case R.id.linear_screen :
                    ...
                    screen.start();
                    Toast.makeText(getActivity(), "截屏成功", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.connect :
